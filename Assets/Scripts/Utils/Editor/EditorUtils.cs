    ...
    public class EditorUtils : MonoBehaviour
    {
        ...
        public static bool BuildGame()
        {
            ...
            buildPlayerOptions.scenes = EditorBuildSettings.scenes
                ...
                .Select(s => s.path)
                .ToArray();
            buildPlayerOptions.locationPathName = Path.Combine("Builds", "Duality.exe");
        ...
        private static void Run(string path, string args)
        {
            ...
            process.StartInfo.WindowStyle = ProcessWindowStyle.Normal; // Choose the window style: Hidden,
                                                                       // Minimized, Maximized, Normal
            process.StartInfo.RedirectStandardOutput = false; // Set to true to redirect the output
                                                              // (so you can read it in Unity)
        ...
        {
            Run("Builds\\Duality.exe", "--server");
            Run("Builds\\Duality.exe", "");
        }
        
        [MenuItem("Tools/Launch (Another Client)", priority = 50)]
        ...
        public static void CloseAll()
        {
            ...
            Process[] processes = Process.GetProcessesByName("Duality");
